  ...
  imagesAndTextObjects: [
    {
      alt: "menu",
      textEng:
        "A restaurant application, possessing three modules: waiters, kitchen and managers.",
      textPl:
        "Aplikacja restauracyjna, posiądająca 3 moduły: kelnerski, kuchenny i menagerski.",
      image: menuImg,
    },
    {
      alt: "dashboard",
      textEng:
        "Dashboard for viewing restaurant data, ability to create new dishes, add new products, waiters, edit dishes.",
      textPl:
        "Dashboard do przeglądania danych restauracji, możliwość tworzenia nowych potraw, dodawania nowych produktów, kelnerów, edytowania potraw. ",
      image: dashboardImg,
    },
    {
      alt: "waiter",
      textEng:
        "Waiter application, ability to create a new order, view active and historical orders.",
      textPl:
        "Aplikacja kelnerska, możliwość stworzenia nowego zamówienia, przeglądania aktywnych i historycznych zamówień. ",
      image: waiterImg,
    },
    {
      alt: "kitchen",
  ...
  imagesAndTextObjects: [
    {
      alt: "WowAuction",
      textEng:
        "Terminal/Windows program in which you can download and plot on the prices of given items in the game World Of Warcraft (INACTIVE change of data formatting by api)",
      textPl:
        "Terminalowy/Okienkowy program w którym można pobrać i sporzjeć na ceny danych przedmiotów w grze World Of Warcraft (NIECZYNNY zmiana formatowania danych przez api)",
      image: wowAhImg,
    },
    {
      alt: "WowAuction",
  ...
  imagesAndTextObjects: [
    {
      alt: "DiscordBot",
      textEng:
        "Window application, once connected to discord, you can play music through a connected bot to the channel.",
      textPl:
        "Aplikacja okienkowa, po połączeniu z discordem można odtworzyć muzykę poprzez podłączonego bota do kanału. ",
...
const gameRental = {
  boolGithub: true,
  urlGitHub: "https://github.com/Kubicki-Maciej/rentGameFrontend",
  technologyUsed: ["Django ", "RestApi ", "React "],
  name: "Game Rental",
  imagesAndTextObjects: [
    {
      alt: "GameRental",
      textEng:
        "The intuitive interface allows you to quickly browse the available games, Rent a game for a particular user.",
      textPl:
        "Intuicyjny interfejs pozwala szybko przeglądać dostępne gry, Wypożyczyć grę dla danego użytkownika.",
    ...
    },
    {
      ...
      textPl:
        "Lista Użytkowników, możliwość sprawdzenia ich wypożyczonych gier.",
      image: gameRentalImg,
    },
